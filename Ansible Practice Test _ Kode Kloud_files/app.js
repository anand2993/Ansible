...
document.addEventListener('DOMContentLoaded', function () {
    ...
    jQuery('.review-slider').slick({
        ...
        dots: false,
        arrows: true,
        appendArrows: '.review-slider-nav',
    ...
    var laptopTab = $('.b-laptop-inner .b-laptop-item');
    var laptopLink = $('.b-tabs .b-tabs__link');
    laptopLink.mouseenter(function (e) {
        e.preventDefault();
        e.stopPropagation();
        var th = $(this);
        var thLink = th.data('link');
        laptopTab.removeClass('current');
        laptopLink.removeClass('current');
        th.addClass('current');
        $('.b-laptop-inner .b-laptop-item[data-tab="' + thLink + '"]').addClass('current');
        if ($('[data-tab="' + thLink + '"]').has('video')) {
            $('[data-tab="' + thLink + '"]').find('video')[0].play();
        } else {
            laptopTab.find('video')[0].pause();
        }
    });
